...
def task_1_1(size):
    ...
    #array = [random.randint(min, max) for k in range(size)] #заменил рандомный array на статичный
    ...
    all_memory([min, max, min_id, max_id, array])
...
# type=<class 'list'>, size=104, obj=[30, 50, 4, 0, [31, 46, 38, 35, 50, 39, 42, 38, 42, 50]]
# type=<class 'int'>, size=28, obj=30
# type=<class 'int'>, size=28, obj=50
# type=<class 'int'>, size=28, obj=4
# type=<class 'int'>, size=24, obj=0
# type=<class 'list'>, size=192, obj=[31, 46, 38, 35, 50, 39, 42, 38, 42, 50]
...
# type=<class 'int'>, size=28, obj=42
# type=<class 'int'>, size=28, obj=50
# Общий объем выделенной памяти под переменные равен 580